...
ANSWERS_FILE = '/liuran/liuran/EEG/EEG_SLEEP_datasets/eval_eeg_successful/json/eeg_answers_640e2a1_2.jsonl'#每个阶段要更改序号
OUTPUT_DIR = '/liuran/liuran/EEG/EEG_SLEEP_datasets/eval_eeg_successful/excel'
OUTPUT_FILE = os.path.join(OUTPUT_DIR, 'eeg_sleep_comparison_640e2a1_2.xlsx')#每个阶段要更改序号,序号以X_0表示，表示无规则识别原则
