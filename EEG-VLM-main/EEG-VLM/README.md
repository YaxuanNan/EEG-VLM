...
deepspeed --include localhost:3 llava/train/train_mem.py \
  ...
  --group_by_modality_length True \
  --bf16 True \
  --output_dir /liuran/liuran/EEG/EEG-VLM-main/checkpoints/run_eeg_vlm_G1_640e2a1b32_1 \
  --num_train_epochs 2 \
...
CUDA_VISIBLE_DEVICES=2 python3 ./llava/eval/model_vqa.py \
  --model-path /liuran/liuran/EEG/EEG-VLM-main/checkpoints/run_eeg_vlm_3_accumulation_steps_2 \
  ...
  --answers-file sleep_data/answers/eeg_answers_3.jsonl \
  --conv-mode llava_v1
```
